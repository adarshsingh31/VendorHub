  ...
  return (
    <section id="seller" className="py-6 sm:py-8">
      <div className="container-page">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-700 via-brand-600 to-brand-800 px-8 py-14 text-white sm:px-14 sm:py-16">
          <div
            aria-hidden="true"
          ...
          <div className="relative grid grid-cols-1 gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link to="/signup">
                  <VHButton variant="local" size="lg" icon={ArrowRight} iconPosition="right" fullWidth className="sm:w-auto">
                    Become a Seller
                  </VHButton>
                </Link>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {sellerFeatures.map((feature) => (
                ...
                >
                  <CheckCircle2 size={16} className="shrink-0 text-local-300" />
