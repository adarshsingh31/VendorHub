...
export default function ResetPassword() {
  ...
  if (status === 'expired') {
    return (
      <AuthLayout heading="Link expired" subheading="Password reset links are only valid for a short time, for your security.">
        <div className="text-center">
          <span className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-danger-50 text-danger-500">
            <XCircle size={28} />
          </span>
          <h2 className="mt-5 font-display text-2xl font-extrabold tracking-tight text-ink-900">
            Reset Link Expired
  ...
  return (
    ...
    >
      ...
      <p className="mt-1.5 text-[15px] text-ink-500">Your new password must be different from previous ones.</p>
