    ...
    <div className="pb-10">
      <div className="flex justify-between items-end mb-6 flex-wrap gap-3">
        <div>
          ...
          <h1 className="font-display text-[26px] font-semibold my-1 text-text">
            Welcome back, Hill Loom Textiles
          </h1>
          <p className="m-0 text-text-muted text-[13.5px]">
            3 orders need packing today, and 2 products are almost out of stock.
          </p>
        </div>
        <div className="flex gap-2.5">
          <button className="bg-surface text-text-soft border border-border font-semibold text-[13px] px-4 py-2.5 rounded-lg hover-lift">
            View storefront
          </button>
          <button
            type="button"
          ...
          <div className="flex justify-between items-start">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#FBEFDA]">
              <svg
                stroke="#B9791C"
                viewBox="0 0 24 24"
                className="w-4 h-4 stroke-[2.2px] fill-none"
              >
      ...
      <div className="grid lg:grid-cols-[1.6fr_1fr] gap-4 items-start">
        <div className="flex flex-col gap-4">
          <div className="bg-surface border border-border rounded-xl p-5">
            <div className="flex justify-between items-center mb-3.5">
              <h3 className="font-display text-[17px] font-semibold m-0 text-text">
                Sales, last 7 days
              </h3>
              <a
                href="#"
                className="text-[12.5px] font-bold text-accent-hover hover:underline"
              >
                Full report →
              </a>
            </div>
            <div className="flex items-end gap-2.5 h-[150px] pt-2.5">
              <div className="flex-1 flex flex-col items-center gap-1.5">
                <div
                  className="w-full rounded-t-[5px] bg-[#EFE3C9]"
                  style={{ height: "58px" }}
                ></div>
          ...
          <div className="bg-surface border border-border rounded-xl p-5">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-[13px]">
                <thead>
                  <tr>
                    <th className="text-left text-text-muted font-semibold text-[11.5px] uppercase tracking-wider pb-2.5 border-b border-border">
                      Order
                    </th>
                    <th className="text-left text-text-muted font-semibold text-[11.5px] uppercase tracking-wider pb-2.5 border-b border-border">
                      Item
                ...
                <tbody>
                  {[
                    {
                      id: "#VH-8823",
                      item: "Handloom cotton saree",
                      buyer: "R. Nair, Kochi",
                      amt: "₹1,499",
                      status: "Pack today",
                      statusClass: "bg-[#FDF0DA] text-[#B9791C]",
                    },
                    {
                      id: "#VH-8819",
                      item: "Linen shirt, tailored",
                      buyer: "A. Iyer, Chennai",
                      amt: "₹899",
                      status: "Shipped",
                      statusClass: "bg-[#E1EFEE] text-[#095857]",
                    },
                    {
                      id: "#VH-8811",
                      item: "Kurta set, block print",
                      buyer: "S. Rao, Hyderabad",
                      amt: "₹1,099",
                      status: "Delivered",
                      statusClass: "bg-[#E6F2E9] text-[#1E7A3E]",
                    },
                    {
                      id: "#VH-8804",
                      item: "Leather sling bag",
                      buyer: "P. Menon, Kozhikode",
                      amt: "₹1,699",
                      status: "Cancelled",
                      statusClass: "bg-danger-bg text-danger-content",
                    },
                    {
                      id: "#VH-8798",
                      item: "Handloom cotton saree",
                      buyer: "D. Kumar, Bengaluru",
                      amt: "₹1,499",
                      status: "Pack today",
                      statusClass: "bg-[#FDF0DA] text-[#B9791C]",
                    },
                    ...
                    >
                      <td className="py-3 pr-2 font-bold text-text">
                        {row.id}
                      </td>
                      ...
                      <td className="py-3 pl-2">
                        <span
                          className={`text-[11px] font-bold px-2.5 py-1 rounded-full ${row.statusClass}`}
                        >
                          {row.status}
                        </span>
                      </td>
        ...
        <div className="flex flex-col gap-4">
            ...
            {[
              {
                ...
                sub: "Coimbatore weave",
                stock: "3 left",
              },
              {
                img: "vh-bag1",
                name: "Leather sling bag, tan",
                sub: "Accessories",
                stock: "1 left",
              },
              {
                img: "vh-shirt1",
                name: "Linen shirt, tailored fit",
                sub: "Menswear",
                stock: "5 left",
              },
            ].map((item, i) => (
              ...
              >
                <img
                  ...
                  src={`https://picsum.photos/seed/${item.img}/80/80`}
                  alt=""
                />
                <div className="flex-1 min-w-0">
                  <b className="block text-[12.5px] font-semibold text-text truncate">
                    {item.name}
                  </b>
          ...
          <div className="bg-surface border border-border rounded-xl p-5">
            <h3 className="font-display text-[17px] font-semibold m-0 mb-3.5 text-text">
              To do
            </h3>
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-2.5 py-2.5 border-b border-border last:border-0 text-[12.5px] text-text"
              >
          ...
          <div className="bg-surface border border-border rounded-xl p-5">
            ...
            {[
              {
                stars: "★★★★★",
                text: "Beautiful weave, exactly as pictured. Fast shipping too.",
                sub: "R. Nair · 2 days ago",
              },
              {
                stars: "★★★★☆",
                text: "Good quality shirt, sizing ran slightly small.",
                sub: "A. Iyer · 5 days ago",
              },
            ].map((rev, i) => (
              <div
                key={i}
              ...
              >
                <div className="text-[#B9791C] text-xs font-bold mb-1">
                  {rev.stars}
                </div>
                <p className="m-0 mb-1 text-[12.5px] text-text-soft">
                  {rev.text}
                </p>
