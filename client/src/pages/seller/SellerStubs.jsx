...
export function AddProductPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pb-12 pt-8">
      ...
      <form id="productForm" onSubmit={handleSubmit} className="space-y-5 mt-6">
        {error && (
        ...
        <div className="panel">
          ...
          >
            ...
            <span>JPG, JPEG, PNG, or WEBP · up to 5 images · max 5MB each</span>
            <input
              ref={fileInputRef}
              id="fileInput"
              type="file"
...
export function EditProductPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pb-12 pt-8">
      <div className="page-head flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-4xl font-display text-text m-0">Edit product</h1>
          <p className="m-0 text-text-muted text-[15px]">
      ...
      <form onSubmit={handleSubmit} className="space-y-5 mt-6">
        ...
        <div className="panel">
          ...
          <div className="mt-4">
            ...
            <div className="image-grid">
              {newImages.length === 0 ? (
                <div className="image-placeholder">No new images selected</div>
              ) : (
